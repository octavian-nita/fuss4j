 ...
 */
public final class Normalize implements Function<CharSequence, String> {
    ...
    private static final Function<CharSequence, String> NORM = MemoizedFn.memoize(new Normalize());
}
